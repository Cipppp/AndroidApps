package com.example.apptimer.util
...
import com.example.apptimer.AppConstants
import com.example.apptimer.MainActivity
import com.example.apptimer.R
import com.example.apptimer.TimerNotificationActionReceiver
...
class NotificationUtil {
    ...
    companion object {
        ...
        fun showTimerExpired(context: Context) {
            ...
            var startPendingIntent = PendingIntent.getBroadcast(context, 0, startIntent, PendingIntent.FLAG_UPDATE_CURRENT)
        ...
        fun showTimerPaused(context: Context) {
            ...
            var resumePendingIntent = PendingIntent.getBroadcast(context, 0, resumeIntent, PendingIntent.FLAG_UPDATE_CURRENT)
        ...
        fun hideTimerNotifaction(context: Context) {
            val nManager = context.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
